...
void main() {
    ...
    group('amount,currency,merchant', () {
      ...
      test('should proceed successfully', () async {
        ...
        verify(mockedHttpClient.post(
                Uri.parse('https://payment.albpay.io/api/checkout/ajax/mobile_pay'),
                body:
  ...
  group('getToken', () {
    test('should proceed successfully with minimal required params', () async {
      ...
      verify(mockedHttpClient.post(
              Uri.parse('https://payment.albpay.io/api/checkout/token'),
              body:
  ...
  group('getOrder', () {
    test('should proceed successfully and parse receipt as well', () async {
      ...
      verify(mockedHttpClient.post(
              Uri.parse('https://payment.albpay.io/api/checkout/merchant/order'),
  ...
  group('checkout', () {
    test('should proceed successfully without email', () async {
      ...
      verify(mockedHttpClient.post(
              Uri.parse('https://payment.albpay.io/api/checkout/ajax'),
              body:
